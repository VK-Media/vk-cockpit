                        ...
                        <div>
                            <div class="uk-form-select">
                                ...
                                <select ref="filtertype" onchange="{ updateFilter }">
                                    ...
                                    <option value="image">{ App.i18n.get('Image') }</option>
                                    <option value="video">{ App.i18n.get('Video') }</option>
                                    <option value="audio">{ App.i18n.get('Audio') }</option>
                                    <option value="document">{ App.i18n.get('Document') }</option>
                                    <option value="archive">{ App.i18n.get('Archive') }</option>
                                    <option value="code">{ App.i18n.get('Code') }</option>
                                </select>
